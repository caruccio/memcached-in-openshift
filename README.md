...
To connect to local gear's memcached use env var ```$OPENSHIFT_INTERNAL_IP``` on port 22322 (if you whant to change it, edit ```.openshift/action_hooks/post_deploy```).
